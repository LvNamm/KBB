            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Giá</th>
                        <th scope="col">Dưới 50</th>
                        <th scope="col">50-200</th>
                        <th scope="col">200-500</th>
                ...
                <tbody id="tbody-classify">
                    <tr>
                        ...
                        <td><input type="text" name="_less50[]" id=""></td>
                        <td><input type="text" name="_50to200[]" id=""></td>
    ...
    <script>
        ...
        function addclassify(){
           ...
           let textAddHtml = `<tr> <td style="display: none"><input type="text" name="_id[]"></td>
            ...
            $("#tbody-classify").html(textHtml+textAddHtml)    
        }
        function myFunction() {
        ...
        function selectProduct(i) {
            ...
            for(let j=0;j<listProduct[i].types.length;j++){
                textHtml += `<tr><td style="display: none"><input type="text" name="_id[]" value = "${listProduct[i].types[j].id}"></td>
                        ...
                        <td><input type="text" name="_less50[]" id="" value = "${listProduct[i].types[j]._less50}"></td>
                        <td><input type="text" name="_50to200[]" id="" value = "${listProduct[i].types[j]._50to200}"></td>
                        <td><input type="text" name="_200to500[]" id="" value = "${listProduct[i].types[j]._200to500}"></td>
                        <td><input type="text" name="_500to1000[]" id="" value = "${listProduct[i].types[j]._500to1000}"></td>
